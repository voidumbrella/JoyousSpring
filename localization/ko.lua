		...
		Joker = {
			...
			j_joy_ba_beatrice = {
				...
				text = {
					...
					"{C:inactive}(현재{} {X:mult,C:white}X#2#{} {C:inactive}배수){}",
					" ",
					"{C:joy_xyz}엑시즈{} {C:attention}#3#{}: {C:joy_normal}\"피안\"{} 조커 (없을시 아무 조커)",
			...
			j_joy_ignis_infant = {
				...
				text = {
					...
					" ",
					"{C:joy_link}링크{} 소환의 소재 한 장을",
					"대체할 수 있으며 아무런 {C:attention}속성{}을",
					"대체할 수 있습니다",
				},
				joy_summon_conditions = {
			...
			j_joy_ignis_templar = {
				...
				text = {
					...
					" ",
					"{C:joy_normal}사이버스족{} 조커의 {C:attention}소재{}로 사용될 시",
					"{C:joy_normal}메인덱 사이버스족{} 조커를 {C:attention}#1#{}장 {C:attention}소생{}시킵니다",
				},
				joy_summon_conditions = {
			...
			j_joy_mudragon = {
				...
				text = {
					"이 조커는 모든 {C:joy_normal}속성{}으로 취급되며",
					"{C:joy_fusion}융합 소환{}의 아무런",
